...
import { Menu, ShoppingCart, Home, Grid, Receipt, User, ArrowRight, ArrowLeft, Trash2, Verified, ShieldCheck, Lock, Zap, Cpu, Battery, Activity } from 'lucide-react';

// --- Shared Components ---

export const Navbar = ({ onNavigate, currentScreen, cartCount }: { onNavigate: (s: string) => void, currentScreen: string, cartCount: number }) => (
...
export const Footer = () => (
  <footer class="mt-12 py-12 px-6 border-t border-outline-variant/10 bg-surface">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
      <p class="text-[10px] font-sans uppercase tracking-[0.2em] text-outline">© 2026 SOLX NEXUS AUTOMOTIVE GROUP</p>
      <div class="flex gap-8">
        <a class="text-[10px] font-sans uppercase tracking-[0.2em] text-outline hover:text-primary transition-colors" href="#">Privacy Protocol</a>
        <a class="text-[10px] font-sans uppercase tracking-[0.2em] text-outline hover:text-primary transition-colors" href="#">Service Terms</a>
        <a class="text-[10px] font-sans uppercase tracking-[0.2em] text-outline hover:text-primary transition-colors" href="#">Support</a>
      </div>
    </div>
  </footer>
);
